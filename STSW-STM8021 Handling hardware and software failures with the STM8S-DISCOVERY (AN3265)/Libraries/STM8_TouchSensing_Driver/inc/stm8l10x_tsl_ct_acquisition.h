/**
  ******************************************************************************
  * @file    stm8l10x_tsl_ct_acquisition.h
...
#ifndef __STM8L10X_TSL_CT_ACQUISITION_H
#define __STM8L10X_TSL_CT_ACQUISITION_H
...
extern __CONST u8 Table_SCKEY_P1[SCKEY_P1_KEY_COUNT];
#endif
#if NUMBER_OF_ACQUISITION_PORTS > 1
extern Info_Channel Channel_P2;
#if NUMBER_OF_SINGLE_CHANNEL_PORTS > 1
extern __CONST u8 Table_SCKEY_P2[SCKEY_P2_KEY_COUNT];
#endif
#endif
...
extern __CONST u8 Table_SCKEY_P3[SCKEY_P3_KEY_COUNT];
#endif
#endif
...
extern __CONST u16 Table_MCKEY_PORTS[];
...
#endif /* __STM8L10X_TSL_CT_ACQUISITION_H */
