...
extern __CONST u16 MCKEY1_DELTA_COEFF[];
extern __CONST u8 MCKEY1_LOOK_TABLE[CHANNEL_PER_MCKEY][2];
#endif
#if NUMBER_OF_MULTI_CHANNEL_KEYS > 1
extern __CONST u8 MCKEY2_LOOK_TABLE[CHANNEL_PER_MCKEY][2];
extern __CONST u16 MCKEY2_DELTA_COEFF[];
#endif
