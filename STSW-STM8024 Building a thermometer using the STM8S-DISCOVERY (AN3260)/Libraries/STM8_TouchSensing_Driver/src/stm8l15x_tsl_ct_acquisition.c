...
void TSL_IO_Init(void)
{
  ...
  IOSR_SAMP = SAMP_CAP_MASK;
	...
	((GPIO_TypeDef *)(ACTIVE_SHIELD_P1_PORT))->DDR &= ~ACTIVE_SHIELD_P1_BIT;
	((GPIO_TypeDef *)(ACTIVE_SHIELD_P1_PORT))->CR1 &= ~ACTIVE_SHIELD_P1_BIT;
	((GPIO_TypeDef *)(ACTIVE_SHIELD_P2_PORT))->DDR &= ~ACTIVE_SHIELD_P2_BIT;
	((GPIO_TypeDef *)(ACTIVE_SHIELD_P2_PORT))->CR1 &= ~ACTIVE_SHIELD_P2_BIT;
#endif
  TSL_IO_Clamp();
